...
const modelsInfo = {
  ...
  AvailabilitySlot: ["id", "startTime", "endTime", "isBooked", "doctorId"],
...
const outputsInfo = {
  ...
  AvailabilitySlotGroupBy: ["id", "startTime", "endTime", "isBooked", "doctorId", "_count", "_avg", "_sum", "_min", "_max"],
  ...
  AvailabilitySlotCountAggregate: ["id", "startTime", "endTime", "isBooked", "doctorId", "_all"],
  AvailabilitySlotAvgAggregate: ["id", "doctorId"],
  AvailabilitySlotSumAggregate: ["id", "doctorId"],
  AvailabilitySlotMinAggregate: ["id", "startTime", "endTime", "isBooked", "doctorId"],
  AvailabilitySlotMaxAggregate: ["id", "startTime", "endTime", "isBooked", "doctorId"],
  ...
  CreateManyAndReturnAvailabilitySlot: ["id", "startTime", "endTime", "isBooked", "doctorId", "doctor"],
...
const inputsInfo = {
  ...
  AvailabilitySlotWhereInput: ["AND", "OR", "NOT", "id", "startTime", "endTime", "isBooked", "doctorId", "doctor"],
  AvailabilitySlotOrderByWithRelationInput: ["id", "startTime", "endTime", "isBooked", "doctorId", "doctor"],
  AvailabilitySlotWhereUniqueInput: ["id", "doctorId", "AND", "OR", "NOT", "startTime", "endTime", "isBooked", "doctor"],
  AvailabilitySlotOrderByWithAggregationInput: ["id", "startTime", "endTime", "isBooked", "doctorId", "_count", "_avg", "_max", "_min", "_sum"],
  AvailabilitySlotScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "startTime", "endTime", "isBooked", "doctorId"],
  ...
  AvailabilitySlotCreateInput: ["startTime", "endTime", "isBooked", "doctor"],
  AvailabilitySlotUpdateInput: ["startTime", "endTime", "isBooked", "doctor"],
  AvailabilitySlotCreateManyInput: ["id", "startTime", "endTime", "isBooked", "doctorId"],
  AvailabilitySlotUpdateManyMutationInput: ["startTime", "endTime", "isBooked"],
  ...
  AvailabilitySlotCountOrderByAggregateInput: ["id", "startTime", "endTime", "isBooked", "doctorId"],
  AvailabilitySlotAvgOrderByAggregateInput: ["id", "doctorId"],
  AvailabilitySlotMaxOrderByAggregateInput: ["id", "startTime", "endTime", "isBooked", "doctorId"],
  AvailabilitySlotMinOrderByAggregateInput: ["id", "startTime", "endTime", "isBooked", "doctorId"],
  ...
  AvailabilitySlotCreateWithoutDoctorInput: ["startTime", "endTime", "isBooked"],
  ...
  AvailabilitySlotScalarWhereInput: ["AND", "OR", "NOT", "id", "startTime", "endTime", "isBooked", "doctorId"],
  ...
  AvailabilitySlotCreateManyDoctorInput: ["id", "startTime", "endTime", "isBooked"],
  ...
  AvailabilitySlotUpdateWithoutDoctorInput: ["startTime", "endTime", "isBooked"],
