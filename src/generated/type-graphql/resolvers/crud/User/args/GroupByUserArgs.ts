...
export class GroupByUserArgs {
  ...
  by!: Array<"id" | "name" | "email" | "password" | "phoneNumber" | "role" | "token" | "tokenExpire" | "otp" | "resetPasswordToken" | "resetPasswordTokenExpire" | "otpExpire" | "profilePicture" | "refreshToken">;
