...
export class CreateManyAndReturnPatientResolver {
  ...
  async createManyAndReturnPatient(@TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args() args: CreateManyAndReturnPatientArgs): Promise<CreateManyAndReturnPatient[]> {
