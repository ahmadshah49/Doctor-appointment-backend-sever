...
const modelsInfo = {
    ...
    AvailabilitySlot: ["id", "startDate", "endDate", "startTime", "endTime", "isBooked", "doctorId"],
    UnavailabilitySlot: ["id", "doctorId", "day", "startTime", "endTime", "startDate", "endDate", "reason", "isAvailable"]
};
...
const outputsInfo = {
    ...
    AvailabilitySlotGroupBy: ["id", "startDate", "endDate", "startTime", "endTime", "isBooked", "doctorId", "_count", "_avg", "_sum", "_min", "_max"],
    AggregateUnavailabilitySlot: ["_count", "_avg", "_sum", "_min", "_max"],
    UnavailabilitySlotGroupBy: ["id", "doctorId", "day", "startTime", "endTime", "startDate", "endDate", "reason", "isAvailable", "_count", "_avg", "_sum", "_min", "_max"],
    ...
    AvailabilitySlotCountAggregate: ["id", "startDate", "endDate", "startTime", "endTime", "isBooked", "doctorId", "_all"],
    AvailabilitySlotAvgAggregate: ["id", "doctorId"],
    AvailabilitySlotSumAggregate: ["id", "doctorId"],
    AvailabilitySlotMinAggregate: ["id", "startDate", "endDate", "startTime", "endTime", "isBooked", "doctorId"],
    AvailabilitySlotMaxAggregate: ["id", "startDate", "endDate", "startTime", "endTime", "isBooked", "doctorId"],
    UnavailabilitySlotCountAggregate: ["id", "doctorId", "day", "startTime", "endTime", "startDate", "endDate", "reason", "isAvailable", "_all"],
    UnavailabilitySlotAvgAggregate: ["id", "doctorId"],
    UnavailabilitySlotSumAggregate: ["id", "doctorId"],
    UnavailabilitySlotMinAggregate: ["id", "doctorId", "day", "startTime", "endTime", "startDate", "endDate", "reason", "isAvailable"],
    UnavailabilitySlotMaxAggregate: ["id", "doctorId", "day", "startTime", "endTime", "startDate", "endDate", "reason", "isAvailable"],
    ...
    CreateManyAndReturnAvailabilitySlot: ["id", "startDate", "endDate", "startTime", "endTime", "isBooked", "doctorId", "doctor"],
    CreateManyAndReturnUnavailabilitySlot: ["id", "doctorId", "day", "startTime", "endTime", "startDate", "endDate", "reason", "isAvailable", "doctor"]
};
...
const inputsInfo = {
    ...
    DoctorOrderByWithRelationInput: ["id", "userId", "name", "profilePhoto", "address", "availability", "email", "isAvailable", "gender", "User", "patients", "appointments", "AvailabilitySlot", "UnavailabilitySlot"],
    DoctorWhereUniqueInput: ["id", "userId", "AND", "OR", "NOT", "name", "profilePhoto", "address", "availability", "email", "isAvailable", "gender", "User", "patients", "appointments", "AvailabilitySlot", "UnavailabilitySlot"],
    ...
    AppointmentWhereUniqueInput: ["id", "doctorId", "patientId", "AND", "OR", "NOT", "fullName", "age", "gender", "phoneNo", "address", "email", "medicalHistory", "presciptions", "details", "scheduledDate", "status", "startTime", "endTime", "Doctor", "Patient"],
    ...
    AvailabilitySlotWhereInput: ["AND", "OR", "NOT", "id", "startDate", "endDate", "startTime", "endTime", "isBooked", "doctorId", "doctor"],
    AvailabilitySlotOrderByWithRelationInput: ["id", "startDate", "endDate", "startTime", "endTime", "isBooked", "doctorId", "doctor"],
    AvailabilitySlotWhereUniqueInput: ["id", "doctorId", "AND", "OR", "NOT", "startDate", "endDate", "startTime", "endTime", "isBooked", "doctor"],
    AvailabilitySlotOrderByWithAggregationInput: ["id", "startDate", "endDate", "startTime", "endTime", "isBooked", "doctorId", "_count", "_avg", "_max", "_min", "_sum"],
    AvailabilitySlotScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "startDate", "endDate", "startTime", "endTime", "isBooked", "doctorId"],
    UnavailabilitySlotWhereInput: ["AND", "OR", "NOT", "id", "doctorId", "day", "startTime", "endTime", "startDate", "endDate", "reason", "isAvailable", "doctor"],
    UnavailabilitySlotOrderByWithRelationInput: ["id", "doctorId", "day", "startTime", "endTime", "startDate", "endDate", "reason", "isAvailable", "doctor"],
    UnavailabilitySlotWhereUniqueInput: ["id", "doctorId", "AND", "OR", "NOT", "day", "startTime", "endTime", "startDate", "endDate", "reason", "isAvailable", "doctor"],
    UnavailabilitySlotOrderByWithAggregationInput: ["id", "doctorId", "day", "startTime", "endTime", "startDate", "endDate", "reason", "isAvailable", "_count", "_avg", "_max", "_min", "_sum"],
    UnavailabilitySlotScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "doctorId", "day", "startTime", "endTime", "startDate", "endDate", "reason", "isAvailable"],
    ...
    DoctorCreateInput: ["name", "profilePhoto", "address", "availability", "email", "isAvailable", "gender", "User", "patients", "appointments", "AvailabilitySlot", "UnavailabilitySlot"],
    DoctorUpdateInput: ["name", "profilePhoto", "address", "availability", "email", "isAvailable", "gender", "User", "patients", "appointments", "AvailabilitySlot", "UnavailabilitySlot"],
    ...
    AvailabilitySlotCreateInput: ["startDate", "endDate", "startTime", "endTime", "isBooked", "doctor"],
    AvailabilitySlotUpdateInput: ["startDate", "endDate", "startTime", "endTime", "isBooked", "doctor"],
    AvailabilitySlotCreateManyInput: ["id", "startDate", "endDate", "startTime", "endTime", "isBooked", "doctorId"],
    AvailabilitySlotUpdateManyMutationInput: ["startDate", "endDate", "startTime", "endTime", "isBooked"],
    UnavailabilitySlotCreateInput: ["day", "startTime", "endTime", "startDate", "endDate", "reason", "isAvailable", "doctor"],
    UnavailabilitySlotUpdateInput: ["day", "startTime", "endTime", "startDate", "endDate", "reason", "isAvailable", "doctor"],
    UnavailabilitySlotCreateManyInput: ["id", "doctorId", "day", "startTime", "endTime", "startDate", "endDate", "reason", "isAvailable"],
    UnavailabilitySlotUpdateManyMutationInput: ["day", "startTime", "endTime", "startDate", "endDate", "reason", "isAvailable"],
    ...
    AvailabilitySlotCountOrderByAggregateInput: ["id", "startDate", "endDate", "startTime", "endTime", "isBooked", "doctorId"],
    AvailabilitySlotAvgOrderByAggregateInput: ["id", "doctorId"],
    AvailabilitySlotMaxOrderByAggregateInput: ["id", "startDate", "endDate", "startTime", "endTime", "isBooked", "doctorId"],
    AvailabilitySlotMinOrderByAggregateInput: ["id", "startDate", "endDate", "startTime", "endTime", "isBooked", "doctorId"],
    AvailabilitySlotSumOrderByAggregateInput: ["id", "doctorId"],
    UnavailabilitySlotCountOrderByAggregateInput: ["id", "doctorId", "day", "startTime", "endTime", "startDate", "endDate", "reason", "isAvailable"],
    UnavailabilitySlotAvgOrderByAggregateInput: ["id", "doctorId"],
    UnavailabilitySlotMaxOrderByAggregateInput: ["id", "doctorId", "day", "startTime", "endTime", "startDate", "endDate", "reason", "isAvailable"],
    UnavailabilitySlotMinOrderByAggregateInput: ["id", "doctorId", "day", "startTime", "endTime", "startDate", "endDate", "reason", "isAvailable"],
    ...
    DoctorCreateWithoutUserInput: ["name", "profilePhoto", "address", "availability", "email", "isAvailable", "gender", "patients", "appointments", "AvailabilitySlot", "UnavailabilitySlot"],
    ...
    DoctorUpdateWithoutUserInput: ["name", "profilePhoto", "address", "availability", "email", "isAvailable", "gender", "patients", "appointments", "AvailabilitySlot", "UnavailabilitySlot"],
    ...
    AvailabilitySlotCreateWithoutDoctorInput: ["startDate", "endDate", "startTime", "endTime", "isBooked"],
    ...
    UnavailabilitySlotCreateWithoutDoctorInput: ["day", "startTime", "endTime", "startDate", "endDate", "reason", "isAvailable"],
    ...
    AvailabilitySlotScalarWhereInput: ["AND", "OR", "NOT", "id", "startDate", "endDate", "startTime", "endTime", "isBooked", "doctorId"],
    ...
    UnavailabilitySlotScalarWhereInput: ["AND", "OR", "NOT", "id", "doctorId", "day", "startTime", "endTime", "startDate", "endDate", "reason", "isAvailable"],
    DoctorCreateWithoutPatientsInput: ["name", "profilePhoto", "address", "availability", "email", "isAvailable", "gender", "User", "appointments", "AvailabilitySlot", "UnavailabilitySlot"],
    ...
    DoctorUpdateWithoutPatientsInput: ["name", "profilePhoto", "address", "availability", "email", "isAvailable", "gender", "User", "appointments", "AvailabilitySlot", "UnavailabilitySlot"],
    ...
    DoctorCreateWithoutAppointmentsInput: ["name", "profilePhoto", "address", "availability", "email", "isAvailable", "gender", "User", "patients", "AvailabilitySlot", "UnavailabilitySlot"],
    ...
    DoctorUpdateWithoutAppointmentsInput: ["name", "profilePhoto", "address", "availability", "email", "isAvailable", "gender", "User", "patients", "AvailabilitySlot", "UnavailabilitySlot"],
    ...
    DoctorCreateWithoutAvailabilitySlotInput: ["name", "profilePhoto", "address", "availability", "email", "isAvailable", "gender", "User", "patients", "appointments", "UnavailabilitySlot"],
    ...
    DoctorUpdateWithoutAvailabilitySlotInput: ["name", "profilePhoto", "address", "availability", "email", "isAvailable", "gender", "User", "patients", "appointments", "UnavailabilitySlot"],
    DoctorCreateWithoutUnavailabilitySlotInput: ["name", "profilePhoto", "address", "availability", "email", "isAvailable", "gender", "User", "patients", "appointments", "AvailabilitySlot"],
    ...
    DoctorUpdateWithoutUnavailabilitySlotInput: ["name", "profilePhoto", "address", "availability", "email", "isAvailable", "gender", "User", "patients", "appointments", "AvailabilitySlot"],
    ...
    AvailabilitySlotCreateManyDoctorInput: ["id", "startDate", "endDate", "startTime", "endTime", "isBooked"],
    UnavailabilitySlotCreateManyDoctorInput: ["id", "day", "startTime", "endTime", "startDate", "endDate", "reason", "isAvailable"],
    ...
    AvailabilitySlotUpdateWithoutDoctorInput: ["startDate", "endDate", "startTime", "endTime", "isBooked"],
    UnavailabilitySlotUpdateWithoutDoctorInput: ["day", "startTime", "endTime", "startDate", "endDate", "reason", "isAvailable"],
